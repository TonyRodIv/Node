...
const server = http.createServer((req, res)=>{
    ...
    if(!name){
        ...
        // Adiciona o valor de name seguido de uma quebra de linha em um arquivo chamado arquivo.txt usando a função appendFile do módulo fs
        // Essa função recebe uma função de callback que é chamada após a adição do arquivo
        const nameNewlIne=name +';\r\n'


        fs.appendFile('arquivo.txt',nameNewlIne,(err,data)=>{
            // Define o status da resposta como 302 (Found) e o cabeçalho Location como '/' usando a função writeHead do objeto res
